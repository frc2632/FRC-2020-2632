...
public class Robot extends TimedRobot {
    ...
    public void robotInit() {
        ...
        Command disableCompressor = new DisableCompressor();

        SmartDashboard.putData("Auto mode", chooser);
        SmartDashboard.putBoolean("Compressor On: ", compressorSubsystem.isOn());
        SmartDashboard.putNumber("LF Motor Port", RobotMap.LFMOTORCONTROLLER);
        SmartDashboard.putData(Scheduler.getInstance());
        SmartDashboard.putData("Disable Compressor", disableCompressor);
